...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__7146__auto__,writer__7147__auto__,opt__7148__auto__){
return cljs.core._write(writer__7147__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__13780 = o;
(G__13780[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__13782__i < G__13782__a.length) {G__13782__a[G__13782__i] = arguments[G__13782__i + 0]; ++G__13782__i;}
  args = new cljs.core.IndexedSeq(G__13782__a,0);
} 
...
if(cljs.core.truth_((function (){var and__6528__auto__ = cljs.core.some_QMARK_(jsprops);
if(and__6528__auto__){
var and__6528__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__13789 = jsprops;
(G__13789["defaultValue"] = value);

(G__13789["onChange"] = ((function (G__13789,v,value,on_change){
return (function (p1__13786_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__13786_SHARP_);
});})(G__13789,v,value,on_change))
);

(G__13789["ref"] = ((function (G__13789,v,value,on_change){
return (function (p1__13787_SHARP_){
return (this$["cljsInputElement"] = p1__13787_SHARP_);
});})(G__13789,v,value,on_change))
);
...
var vec__13794 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13794,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13794,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13794,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___13797 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___13797 == null)){
} else {
var key_13798 = temp__4661__auto___13797;
(jsprops["key"] = key_13798);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__13800 = (new reagent.impl.template.NativeWrapper());
(G__13800["name"] = c);
...
var G__13802 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__13802) : reagent.impl.template.as_element.call(null,G__13802));
} else {
...
var len__7610__auto___13808 = arguments.length;
var i__7611__auto___13809 = (0);
while(true){
if((i__7611__auto___13809 < len__7610__auto___13808)){
args__7617__auto__.push((arguments[i__7611__auto___13809]));

var G__13810 = (i__7611__auto___13809 + (1));
i__7611__auto___13809 = G__13810;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7618__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq13806){
var G__13807 = cljs.core.first(seq13806);
var seq13806__$1 = cljs.core.next(seq13806);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__13807,seq13806__$1);
});
...
break;
default:
var G__13814 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__13814;
continue;
...
var n__7455__auto___13817 = a.length;
var i_13818 = (0);
while(true){
if((i_13818 < n__7455__auto___13817)){
(a[i_13818] = reagent.impl.template.as_element((a[i_13818])));

var G__13819 = (i_13818 + (1));
i_13818 = G__13819;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7455__auto___13820 = a.length;
var i_13821 = (0);
while(true){
if((i_13821 < n__7455__auto___13820)){
var val_13822 = (a[i_13821]);
if((cljs.core.vector_QMARK_(val_13822)) && ((reagent.impl.template.key_from_vec(val_13822) == null))){
(o["no-key"] = true);
} else {
}

(a[i_13821] = reagent.impl.template.as_element(val_13822));

var G__13823 = (i_13821 + (1));
i_13821 = G__13823;
continue;
} else {
}
...
var ctx = {};
var vec__13825 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13825,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13825,(1),null);
...
var G__13827 = (cljs.core.count(argv) - first_child);
switch (G__13827) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__13827){
