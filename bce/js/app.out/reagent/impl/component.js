...
if((i < len)){
var k = (ks[i]);
var G__13703 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__13704 = (i + (1));
m = G__13703;
i = G__13704;
continue;
...
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__13708 = c;
var G__13708__$1 = (((G__13708 == null))?null:G__13708.prototype);
if((G__13708__$1 == null)){
return null;
} else {
return (G__13708__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__13712 = c;
var G__13712__$1 = (((G__13712 == null))?null:G__13712.prototype);
if((G__13712__$1 == null)){
return null;
} else {
return (G__13712__$1["render"]);
}
})()));
});
...
var G__13716 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__13716) : reagent.impl.component.as_element.call(null,G__13716));
};
...
while (G__13719__i < G__13719__a.length) {G__13719__a[G__13719__i] = arguments[G__13719__i + 0]; ++G__13719__i;}
  args = new cljs.core.IndexedSeq(G__13719__a,0);
} 
...
var _STAR_current_component_STAR_13723 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_13723;
}});
...
var G__13731 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__13731) {
...
return ((function (G__13731){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__13734 = reagent.impl.component.state_atom(c);
var G__13735 = f.call(c,c);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__13734,G__13735) : cljs.core.reset_BANG_.call(null,G__13734,G__13735));
});
;})(G__13731))
...
var or__6540__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__13737_13739 = (c["cljsRatom"]);
if((G__13737_13739 == null)){
} else {
reagent.ratom.dispose_BANG_(G__13737_13739);
}
...
if(cljs.core.truth_((function (){var and__6528__auto__ = wrap;
...
var renders_13742 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_13743 = cljs.core.first(cljs.core.vals(renders_13742));
if((cljs.core.count(renders_13742) > (0))){
} else {
...
if(((1) === cljs.core.count(renders_13742))){
} else {
...
if(cljs.core.ifn_QMARK_(render_fun_13743)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([render_fun_13743], 0)))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__6540__auto__ = cljs.core.cst$kw$reagentRender.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__6540__auto__)){
return or__6540__auto__;
} else {
...
var render_fun__$1 = (function (){var or__6540__auto__ = render_fun;
if(cljs.core.truth_(or__6540__auto__)){
return or__6540__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__6540__auto__ = cljs.core.cst$kw$displayName.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__6540__auto__)){
return or__6540__auto__;
} else {
...
var name__$1 = (function (){var G__13741 = name;
switch (G__13741) {
case "":
...
var elem = (function (){var G__13752 = (function (){var or__6540__auto__ = (function (){var G__13754 = c;
if((G__13754 == null)){
return null;
} else {
return (G__13754["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__6540__auto__)){
return or__6540__auto__;
...
return (G__13752["_currentElement"]);
}
})();
var name = (function (){var G__13755 = elem;
var G__13755__$1 = (((G__13755 == null))?null:(G__13755["type"]));
if((G__13755__$1 == null)){
return null;
} else {
return (G__13755__$1["displayName"]);
}
})();
var path = (function (){var G__13756 = elem;
var G__13756__$1 = (((G__13756 == null))?null:(G__13756["_owner"]));
var G__13756__$2 = (((G__13756__$1 == null))?null:reagent$impl$component$component_path(G__13756__$1));
if((G__13756__$2 == null)){
return null;
} else {
return [cljs.core.str(G__13756__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__6540__auto__ = reagent.impl.component.component_path(c);
if(cljs.core.truth_(or__6540__auto__)){
return or__6540__auto__;
} else {
var G__13758 = c;
var G__13758__$1 = (((G__13758 == null))?null:G__13758.constructor);
if((G__13758__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__13758__$1);
}
}
})();
